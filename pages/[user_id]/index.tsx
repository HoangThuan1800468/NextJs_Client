...
export default function UserPage() {
  ...
  return (     
    ...
    <div>
        ...
        <div></div>
        <button><Link href={`/${userid}/productOwner`}>Product Owner</Link></button>
        <div></div>
        <button onClick={handleFecthUser}><Link href={`/${userid}/userInformation`}>Change your information</Link></button>
        <div></div>
        <button><Link href={`/${userid}/walletUser`}>Wallet</Link></button>
        <div></div>
        <hr/>
        <h1>User infor:</h1>
        <ul>
